      ...
      <section className="proof shell" aria-labelledby="proof-title">
        ...
        <div className="proof-grid">
          ...
          <div className="proof-note">
            <p>
              Generated by the same deployed voice from notes about AI memory,
              then lightly fact-checked. Stylometric match: <strong>0.851</strong>.
            </p>
            <a href="https://github.com/samzliu/voiceprint/blob/main/examples/ai-memory-is-a-control-problem.md">
